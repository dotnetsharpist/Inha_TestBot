...
public class ContractIssueController(IContractIssueService service) : BaseController
{
    [HttpGet]
    [AllowAnonymous]
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync(ContractIssueCreateDto dto)
        => Ok(new Response
        {
            Code = 200,
            Message = "Ok",
