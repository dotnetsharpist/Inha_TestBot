...
public class ContractProductController(IContractProductService service) : BaseController
{
    [HttpGet]
    [AllowAnonymous]
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync(ContractProductCreateDto dto)
        => Ok(new Response
        {
            Code = 200,
            Message = "Ok",
