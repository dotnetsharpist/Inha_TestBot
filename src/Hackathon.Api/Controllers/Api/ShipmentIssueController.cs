...
public class ShipmentIssueController(IShipmentIssueService service) : BaseController
{
    [HttpGet]
    [AllowAnonymous]
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync(ShipmentIssueCreateDto dto)
        => Ok(new Response
        {
            Code = 200,
            Message = "Ok",
