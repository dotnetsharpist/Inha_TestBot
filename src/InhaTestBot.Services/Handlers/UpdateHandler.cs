...
namespace InhaTestBot.Services.Handlers;

public class UpdateHandler(ITelegramBotClient bot, ILogger<UpdateHandler> logger, IStateService stateService, IBotUserService botUserService, IMapper mapper) : IUpdateHandler
{
