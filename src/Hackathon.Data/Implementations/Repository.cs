...
namespace InhaTestBot.Data.Implementations;
    ...
    public class Repository<TEntity>(HackathonDbContext testDbContext) : IRepository<TEntity>
        where TEntity : Auditable
    {
        private readonly DbSet<TEntity> _dbSet = testDbContext.Set<TEntity>();
        ...
        {
            return await testDbContext.SaveChangesAsync() >= 0;
        }
        ...
        {
            EntityEntry<TEntity> entryentity = testDbContext.Update(entity);
